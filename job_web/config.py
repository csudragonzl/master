...
class BaseConfig(object):
    ...
    JOB_INDEX_PER_PAGE = 20
    GROUP_INDEX_PER_PAGE = 20
    EVENT_INDEX_PER_PAGE = 18
    MEMBER_INDEX_PER_PAGE = 20
    COMPANY_INDEX_PER_PAGE = 20
    COMPANY_DETAIL_PER_PAGE = 10
    GROUP_DETAIL_PER_PAGE = 10
    LIST_PER_PAGE = 15


class DevelopmentConfig(BaseConfig):
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = 'mysql+mysqldb://root:root@127.0.0.1:3306/job_web?charset=utf8'
